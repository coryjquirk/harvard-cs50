...
int main(void)
{
    ...
    int sumOfDoubledDigits = ((((digitTwo * 2)%100)/10)+((digitTwo*2)%10)) + ((((digitFour * 2)%100)/10)+((digitFour*2)%10)) + ((((digitSix * 2)%100)/10)+((digitSix*2)%10)) + ((((digitEight * 2)%100)/10)+((digitEight*2)%10)) + ((((digitTen * 2)%100)/10)+((digitTen*2)%10)) + ((((digitTwelve * 2)%100)/10)+((digitTwelve*2)%10)) + ((((digitFourteen * 2)%100)/10)+((digitFourteen*2)%10)) + ((((digitSixteen * 2)%100)/10)+((digitSixteen*2)%10));
